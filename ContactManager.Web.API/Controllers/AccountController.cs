...
using ContactManager.Web.API.Models;
using ContactManager.Web.API.Providers;
using ContactManager.Web.API.Results;

namespace ContactManager.Web.API.Controllers
{
    [Authorize]
